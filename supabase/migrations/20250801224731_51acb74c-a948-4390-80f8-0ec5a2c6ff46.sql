...
SELECT id, nome, descricao, ordem FROM (
  VALUES 
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'criativo';
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'oferta';
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'copy';
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'audiencia';
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'landing_page';
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'email';
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'preco';
...
CROSS JOIN public.tipos_experimento WHERE codigo = 'produto';
